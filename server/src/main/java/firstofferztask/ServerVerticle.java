...
public class ServerVerticle extends AbstractVerticle {
  ...
  public void start() throws Exception {
    ...
    route3.handler(CorsHandler.create().allowedMethods(allowedMethods).allowCredentials(true));
    ...
    route4.handler(CorsHandler.create().allowedMethods(allowedMethods).allowCredentials(true));
  ...
  private void fetchCurrentForecast(String city, String country, RoutingContext context) {
    ...
    HttpRequest<JsonObject> request = WebClient.create(vertx)
      ...
      .putHeader("Access-Control-Allow-Origin", "*") // didn't work
